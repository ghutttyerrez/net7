...
export default function MinhaNet7Section() {
  ...
  const buttonClass = "group inline-flex items-center gap-3 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-md px-5 py-4 hover:border-brand-blue dark:hover:border-brand-lime transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue dark:focus-visible:ring-brand-lime focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black shadow-sm hover:shadow w-full sm:w-auto min-w-[260px] justify-center"
  const iconContainerClass = "flex-shrink-0 w-11 h-11 rounded-lg flex items-center justify-center text-white shadow-inner"
  const textContainerClass = "text-left"
  const subtitleClass = "text-xs uppercase tracking-wide font-semibold text-neutral-500 dark:text-brand-light/60 h-4 flex items-center"
  const titleClass = "text-base font-medium text-brand-blue dark:text-brand-lime group-hover:underline"
  ...
  <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center sm:items-center w-full max-w-md mx-auto" data-reveal data-reveal-delay="200">
          ...
          >
            <div className={`${iconContainerClass} bg-gradient-to-br from-neutral-900 to-neutral-700`}>
          ...
          <a
            ...
            className={buttonClass}
          >
            <div className={`${iconContainerClass} bg-gradient-to-br from-green-600 to-emerald-500`}>
