...
export default function MinhaNet7Section() {
  ...
  <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center" data-reveal data-reveal-delay="200">
          <a
            href="https://apps.apple.com/br/app/minha-net-7/id6745264071"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => handleClick('ios')}
            className="group inline-flex items-center gap-4 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-md px-6 py-4 hover:border-brand-blue dark:hover:border-brand-lime transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue dark:focus-visible:ring-brand-lime focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black shadow-sm hover:shadow">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-neutral-900 to-neutral-700 flex items-center justify-center text-white shadow-inner">
          ...
          <a
            ...
            className="group inline-flex items-center gap-4 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-md px-6 py-4 hover:border-brand-blue dark:hover:border-brand-lime transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue dark:focus-visible:ring-brand-lime focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-black shadow-sm hover:shadow">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-green-600 to-emerald-500 flex items-center justify-center text-white shadow-inner">
